...
data class AndroidAnalysisAttempt(
    ...
    val experimentMode: String = PipelineExperimentMode.DEFAULT.id,
    val experimentStages: String = PipelineExperimentMode.DEFAULT.stageMask,
    val latencyMs: Long,
    val parseDelayMs: Long = -1L,
    val candidateExtractionMs: Long = -1L,
    val nodeCollectionMs: Long = -1L,
    val visualRoiPlanningMs: Long = -1L,
    val screenCandidateExtractionMs: Long = -1L,
    val candidatePostProcessingMs: Long = -1L,
    val candidateParallelWaitMs: Long = -1L,
    val accessibilityMaskLatencyMs: Long = -1L,
    val riskGateMaskMs: Long = -1L,
    val riskGateEventAgeMs: Long = -1L,
    val riskGateReceiveToMaskMs: Long = -1L,
    val fastProvisionalMaskMs: Long = -1L,
    val fastProvisionalEventAgeMs: Long = -1L,
    val fastProvisionalBuildMs: Long = -1L,
    val fastProvisionalOverlayMs: Long = -1L,
    val fastProvisionalReceiveToMaskMs: Long = -1L,
    val backendMaskLatencyMs: Long = -1L,
    val visualOcrLatencyMs: Long = -1L,
    val visualMaskLatencyMs: Long = -1L,
    val nodeCount: Int = 0,
    val screenCandidateCount: Int = 0,
    val charLocationNodeCount: Int = 0,
    val charRangeCandidateCount: Int = 0,
...
data class AndroidAnalysisDiagnostics(
    ...
    val url: String,
    val sensitivity: Int?,
    val experimentMode: String,
    val experimentStages: String,
    val latencyMs: Long,
    ...
    val candidatePostProcessingMs: Long,
    val candidateParallelWaitMs: Long,
    val accessibilityMaskLatencyMs: Long,
    val riskGateMaskMs: Long,
    val riskGateEventAgeMs: Long,
    val riskGateReceiveToMaskMs: Long,
    val fastProvisionalMaskMs: Long,
    val fastProvisionalEventAgeMs: Long,
    val fastProvisionalBuildMs: Long,
    val fastProvisionalOverlayMs: Long,
    val fastProvisionalReceiveToMaskMs: Long,
    val backendMaskLatencyMs: Long,
    val visualOcrLatencyMs: Long,
    val visualMaskLatencyMs: Long,
    val nodeCount: Int,
    val screenCandidateCount: Int,
    val charLocationNodeCount: Int,
    val charRangeCandidateCount: Int,
    val commentCount: Int,
    val offensiveCount: Int,
    val filteredCount: Int,
