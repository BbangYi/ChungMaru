...
- generated_at: `2026-07-03T14:28:44+09:00`
...
| status | case/domain | category | risk | runs | action runs | action max | false hidden max | collect p95 | filter p95 | apply p95 | dom->action p95 | screens |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| benign_negative | developer.mozilla.org | benign | allow | 1 | 0 | 0 | 0 | 4 | 0 | 0 | 0 | 1 |
| benign_negative | example.com | benign | allow | 1 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 1 |
| benign_negative | google.com | benign-thumbnail | allow | 2 | 0 | 0 | 0 | 2 | 0 | 0 | 0 | 2 |
| benign_negative | python.org | benign | allow | 1 | 0 | 0 | 0 | 3 | 0 | 0 | 0 | 1 |
| benign_negative | wikipedia.org | benign | allow | 1 | 0 | 0 | 0 | 2 | 0 | 0 | 0 | 1 |
| benign_negative | youtube.com | benign-thumbnail | allow | 2 | 0 | 0 | 0 | 10 | 0 | 0 | 0 | 2 |
| benign_negative | example.com | benign | allow | 3 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 1 |
| strong_visual_block | jusoguide1.com | gambling | block | 3 | 3 | 18 | 0 | 4 | 0 | 3 | 1 | 1 |
| strong_visual_block | jusowhy1.com | gambling | block | 3 | 3 | 34 | 0 | 3 | 0 | 7 | 5 | 1 |
| benign_negative | wikipedia.org | benign | allow | 3 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 1 |
| strong_visual_block | log_off_harmful | harmful | block | 1 | 1 | 2 | 0 | 1 | 0 | 0 | 0 | 0 |
| strong_visual_block | log_on_address_guide_video | address-guide-video | block | 1 | 1 | 1 | 0 | 2 | 0 | 0 | 1 | 0 |
| benign_negative | log_on_clean | clean | allow | 1 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 |
| strong_visual_block | log_on_harmful | harmful | block | 1 | 1 | 2 | 0 | 1 | 0 | 0 | 0 | 0 |
| strong_visual_block | log_on_late_load | late-load | block | 1 | 1 | 1 | 0 | 1 | 0 | 0 | 0 | 0 |
| disabled_control | media_off_harmful | harmful | disabled-control | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
