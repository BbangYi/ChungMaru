...
// Follow-up corrections must not outlive the user-visible one-second budget.
const RECONCILE_ANALYZE_TIMEOUT_MS = 850;
...
const BACKGROUND_VALIDATION_BACKEND_BUDGET_MS = 120;
