...
- 검색 결과 보호는 Google 검색 결과에 노출된 링크를 수동 차단/경고 도메인과 `/site/check` 판정으로 함께 확인합니다. 차단 판정은 링크와 요약을 숨기고, 경고 판정은 흐림 처리합니다. 백엔드 판정은 한 번에 최대 12개 결과만 제한적으로 확인하고 10분 동안 캐시합니다.
